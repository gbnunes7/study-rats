...
- **RF001** - O sistema deve permitir o cadastro de novos usuários via e-mail e senha.
- **RF002** - O sistema deve permitir o login de usuários usando e-mail/senha ou Google Login.
- **RF003** - O sistema deve permitir que o usuário preencha/atualize seu perfil com nome, foto, matérias de interesse e bio curta.
- **RF004** - O sistema deve permitir que um usuário crie grupos de estudo, informando nome, descrição, matérias focadas e se o grupo será público ou privado.
- **RF005** - O sistema deve listar grupos públicos disponíveis para que os usuários possam visualizá-los e solicitar entrada.
- **RF006** - O sistema deve permitir a entrada em grupos privados apenas via link de convite.
...
- **RF009** - O sistema deve permitir visualizar o perfil básico de outros usuários dentro dos grupos.
...
- **RN001** - Um usuário não pode criar mais de 5 grupos de estudo simultaneamente (limite para o MVP).
- **RN002** - Grupos públicos podem ser acessados e entrados livremente pelos usuários logados.
- **RN003** - Grupos privados só podem ser acessados através de link de convite válido.
